...
// Called every frame
void UFirstOpenDoor::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void UFirstOpenDoor::OpenDoor(float DeltaTime)
{
...
void UFirstOpenDoor::CloseDoor(float DeltaTime)
{
